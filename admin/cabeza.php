  ...
  <body class="app sidebar-mini" style="font-family: 'Open Sans', sans-serif;">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu" style="font-weight: bold;">
        <li><a class="app-menu__item " href="index.php?action=view_dashboard"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">DASHBOARD</span></a></li>
